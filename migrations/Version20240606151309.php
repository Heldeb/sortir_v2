 ...
 */
final class Version20240606151309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sortie (id INT AUTO_INCREMENT NOT NULL, lieu_id INT NOT NULL, site_id INT NOT NULL, etat_id INT NOT NULL, organisateur_id INT NOT NULL, nom VARCHAR(30) NOT NULL, datedebut DATETIME NOT NULL, duree INT DEFAULT NULL, datecloture DATETIME NOT NULL, nbinscriptionsmax INT NOT NULL, descriptioninfos VARCHAR(500) DEFAULT NULL, url_photo VARCHAR(250) DEFAULT NULL, INDEX IDX_3C3FD3F26AB213CC (lieu_id), INDEX IDX_3C3FD3F2F6BD1646 (site_id), INDEX IDX_3C3FD3F2D5E86FF (etat_id), INDEX IDX_3C3FD3F2D936B2FA (organisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE filtres ADD site INT DEFAULT NULL, ADD organisateur TINYINT(1) DEFAULT NULL, ADD inscrit TINYINT(1) DEFAULT NULL, ADD non_inscrit TINYINT(1) DEFAULT NULL, ADD sortie_passee TINYINT(1) DEFAULT NULL, DROP site_id, DROP inscription_id, CHANGE nom_lieu contient VARCHAR(30) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE filtres ADD inscription_id INT DEFAULT NULL, DROP organisateur, DROP inscrit, DROP non_inscrit, DROP sortie_passee, CHANGE site site_id INT DEFAULT NULL, CHANGE contient nom_lieu VARCHAR(30) DEFAULT NULL');
    }
}
